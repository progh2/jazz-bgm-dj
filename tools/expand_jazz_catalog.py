...
SEARCH_QUERIES = [
    ...
    ("TeknoAXE lounge", "TeknoAXE"),
    ("TeknoAXE blues", "TeknoAXE"),
    ("TeknoAXE funk", "TeknoAXE"),
    ("\"Stomping at Midnight\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Maple Leaf Rag\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Airport Lounge\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Backbay Lounge\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Ultralounge\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"OctoBlues\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Tiki Bar Mixer\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Late Night Radio\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Palm and Soul\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"BossaBossa\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Got Funk\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Groove Grove\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Local Forecast\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Mining by Moonlight\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Carefree\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Nonstop\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Acoustic Blues\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Big Band Swingin\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Leopard Print Elevator\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Funky Chunk\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Clean Soul\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Blobby Samba\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Casa Bossa Nova\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Natural Vibes\" Kevin MacLeod", "Kevin MacLeod"),
    ("\"Frogs Legs Rag\" Kevin MacLeod", "Kevin MacLeod"),
    ("Audionautix \"jazz\"", "Audionautix"),
    ("Audionautix big band", "Audionautix"),
    ("Audionautix ragtime", "Audionautix"),
    ("Audionautix noir", "Audionautix"),
    ("Twin Musicom swing", "Twin Musicom"),
    ("Twin Musicom bossa", "Twin Musicom"),
    ("MusMus ジャズピアノ", "MusMus"),
    ("MusMus ラウンジ", "MusMus"),
    ("魔王魂 ラウンジ", "魔王魂"),
    ("魔王魂 カフェ", "魔王魂"),
    ("Eric Matyas jazz", "Eric Matyas"),
    ("Eric Matyas lounge", "Eric Matyas"),
    ("Eric Matyas blues", "Eric Matyas"),
    ("Soundimage jazz", "Eric Matyas"),
    ("Soundimage lounge", "Eric Matyas"),
]
